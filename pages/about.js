    ...
    <div className="mt-12 container">
      <div className="about-section">
        ...
        <p>
          ...
          growth in a direction and making required changes in their position".
        </p>
        <p>
          ...
          since its inception over past 16 years. Students preparing for officer
          rank positions need command over their English language. Pace
          Institute has been making people proficient in English language and
          personality development to attain significant positions. PACE stands
          for Personality Attainment & Communicative English. PACE Institute
          Pvt. Ltd. is a registered Institute and can also issue certification
          to its students.
        </p>
      </div>
      <div className="about-section">
        ...
        <p>
          ...
          factors and life-altering experiences. Personality development is also
          dimensional in description and subjective in nature. That is,
          personality development can be seen as a continuum varying in degrees
          of intensity and change. It is subjective in nature because its
          conceptualization is rooted in social norms of expected behavior,
      ...
      <div className="about-section">
        ...
        <p>
          ...
          has been updating itself with time from old English to modern English
          with institutions like PACE working sincerely. Modern English has been
          spreading around the world due to its flexibility and adaptability.
          English has become the leading language of international discourse and
          communication in many regions and professional contexts such as
          science, navigation and law. Modern English grammar is the result of a
          gradual change from a typical Indo-European dependent marking pattern,
          with a rich inflectional morphology and relatively free word order, to
          a mostly analytic pattern with little inflection, a fairly fixed
          subject–verb–object word order (pattern) and a complex syntax. Modern
          English relies more on auxiliary verbs and word order for the
        ...
        <p>
          Indian English is a class of varieties of the English language spoken
          in India, and among the Indian diaspora elsewhere in the world.
          English is used by the Indian government for some communication as a
          supplement to Hindi, the country’s “official language of the Union”,
          enshrined in the Constitution. English is an official language of 7
          states and 5 Union Territories and also additional official language
          of 7 states and 1 Union Territory. English is also the sole official
          language of the Judiciary of India, unless a state Governor or
          legislature mandates the use of regional language, or the President
